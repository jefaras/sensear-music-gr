          ...
          <div className="space-y-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-4xl md:text-[48px] font-bold text-black mb-4 leading-tight">Yam, Antiparos</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-1">
                <h3 className="text-4xl md:text-[48px] font-bold text-black mb-4 leading-tight">Pelicanos, Sifnos</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-4xl md:text-[48px] font-bold text-black mb-4 leading-tight">Beach House, Antiparos</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-1">
                <h3 className="text-4xl md:text-[48px] font-bold text-black mb-4 leading-tight">Levantis, Paros</h3>
