          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col justify-center text-left">
              ...
              <div className="mb-8 max-w-xl slide-up-2">
                <p className="text-2xl sm:text-[1.65rem] md:text-[1.9rem] lg:text-[2.15rem] font-semibold text-black/70 leading-relaxed mb-2 italic">
                  Every venue has a story.<br />Let music tell yours.
                </p>
